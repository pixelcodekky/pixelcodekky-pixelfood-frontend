    ...
    return (
        <>
            <div className="space-y-2 flex flex-col">
                <div className='flex'>
                    <div className="flex justify-center text-md font-semibold text-sm">
                    ...
                    {cuisineList.slice(0, isExpanded ? cuisineList.length : 7).map((cuisine, index) => {
                        ...
                        return (
                            <div key={index} className='flex mb-2'>
                                ...
                                className={`flex flex-1 items-center cursor-pointer rounded-full px-2 py-1 font-semibold ${isSelected ? "border border-green-600 text-green-600" : "border border-slate-400"}`}>
                                    {cuisine}
