...
import { useGeocodingSearch } from '@/common/useGeocodingSearch';
    ...
    return (
        ...
        <div className='flex flex-col md:px-20 pag-12 relative'>
            <div className='md:px-20 bg-white rounded-lg shadow-md py-2 flex flex-col text-center -mt-20'>
                ...
                <SearchBarGeolocation
                    ...
                    setGeocodingCollectionState={clearSearch}
                ...
                {searchResults.length > 0 ? (
                    <div className='w-full flex flex-col relative'>
                        <SearchResultList results={searchResults} handler={onSelect} className={hideSuggestion ? "invisible" : "visible"} />
                    </div>
                ) : null}
                {showSavedAddress ? (
                    <div className='w-full flex flex-col relative animate-fadeIn'>
                        <SavedAddressList className='block' handler={onSelect} />
                    </div>
                ) : null}
            </div>
        </div>
        ...
        <div className='py-5'>
            <div className='min-h-[280px] grid gap-4 lg:md:grid-cols-3'>
                <div className='gap-5 item-center py-20'>
                    ...
                    <div className='text-3xl text-center font-bold flex flex-row justify-center'>
                        <span className='rounded-full'>Select Location</span>
                    </div>
                </div>
                <div className='gap-5 item-center py-20'>
                    <div className='flex flex-row justify-center'>
            ...
            <div className='gap-5 py-5 grid md:grid-cols-2'>
                <div className='flex-none w-30'>
                    <h2 className='text-3xl font-bold py-2'>Everything you order, delivered</h2>
                    <p className='text-m gap-2'>
                        ...
                        spread? No problem. We deliver it all, ensuring convenience and satisfaction with every order.
                    </p>
                </div>
            ...
            <div className='grid md:grid-cols-2 gap-5 py-5'>
                ...
                <div>
                    <h2 className='text-3xl font-bold py-2'>Deliver with less, Eat more</h2>
                    <h3 className='text-xl font-bold'>Feeling overwhelmed? Short on time?</h3>
        ...
        <div className="grid md:grid-cols-2 gap-5 py-5">
            ...
            <div className='flex flex-col items-center justify-center gap-4 text-center'>
                <span className='font-bold text-3xl tracking-tighter'>Order takeaway</span>
                <span>Download PixelFood App (Coming Soon) for more...</span>
